...
import { FiUsers, FiClock, FiGlobe, FiLinkedin, FiGithub, FiInstagram } from 'react-icons/fi'
...
const RemoteTeam = () => {
  ...
  const teamMembers = [
    {
      ...
      social: {
        ...
        instagram: "https://www.instagram.com/__jaw_breaker___/"
      },
    ...
    },
    {
      ...
      social: {
        ...
        instagram: "https://www.instagram.com/krishna.3kay/"
      },
    ...
    },
    {
      ...
      social: {
        linkedin: "https://www.linkedin.com/in/retesh-kumar-sharma/",
        github: "https://github.com/rksharma7071",
        instagram: "https://www.instagram.com/g_rksharma/"
      },
    ...
    },
    {
      ...
      social: {
        ...
        instagram: "https://www.instagram.com/im_ansar.khan/"
      },
  ...
  return (
    <section id="remote-team" className="font-sans section-padding bg-gradient-to-b from-gray-50 to-white dark:from-dark-800 dark:to-dark-900" ref={ref}>
      <div className="container-custom">
        ...
        >
          Hire Remotely Software Engineer
        </motion.h2>
              ...
              <SwiperSlide key={index}>
                <div className="card overflow-hidden">
                  <div className="relative h-48 overflow-hidden flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-dark-700 dark:to-dark-600">
                    <motion.div className="relative w-32 h-32 group" whileHover={{ scale: 1.1 }} transition={{ type: "spring", stiffness: 300, damping: 20 }}>
                      <motion.div className="absolute inset-0 rounded-full bg-gradient-to-r from-primary-500 via-secondary-500 to-accent-500 p-1" animate={{ rotate: 360 }} transition={{ duration: 8, repeat: Infinity, ease: "linear" }}>
                        <div className="w-full h-full rounded-full bg-white dark:bg-dark-800" />
                      </motion.div>
                      <motion.div className="relative z-10 w-full h-full rounded-full overflow-hidden shadow-xl border-2 border-white dark:border-dark-600" whileHover={{ boxShadow: "0 15px 30px rgba(58, 134, 255, 0.3)", scale: 1.05 }} transition={{ duration: 0.3 }}>
                        <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-transparent z-10" />
                        <img src={member.image} alt={member.name} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                        <motion.div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 z-20" animate={{ x: ['-100%', '100%'] }} transition={{ duration: 3, repeat: Infinity, repeatDelay: 4, ease: "easeInOut" }} />
                      </motion.div>
                      <motion.div className="absolute inset-0 rounded-full border-2 border-primary-500/50" animate={{ scale: [1, 1.2, 1], opacity: [0.5, 0.8, 0.5] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }} />
                      <motion.div className="absolute -top-2 -right-2 w-4 h-4 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full shadow-lg" animate={{ y: [0, -5, 0], scale: [1, 1.2, 1] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }} />
                      <motion.div className="absolute -bottom-2 -left-2 w-3 h-3 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-full shadow-lg" animate={{ y: [0, 5, 0], scale: [1, 0.8, 1] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut", delay: 1 }} />
                    </motion.div>

                    <img src={member.image} alt={member.name} className="w-full h-full object-cover" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
                      <div className="flex space-x-3">
                        <a href={member.social.linkedin} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white hover:text-primary-500 transition-colors">
                          <FiLinkedin size={16} />
                        </a>
                        <a href={member.social.github} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white hover:text-primary-500 transition-colors">
                          <FiGithub size={16} />
                        </a>
                        {member.social.instagram && (
                          <a href={member.social.instagram} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white hover:text-primary-500 transition-colors">
                            <FiInstagram size={16} />
                          </a>
                        )}
                      </div>
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-dark-500 dark:text-gray-400 text-sm mb-4">{member.description}</p>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {member.skills.map((skill, idx) => (
                        <span key={idx} className="px-3 py-1 rounded-full text-xs font-medium bg-primary-500/10 text-primary-500">
                          {skill}
                        </span>
                      ))}
                    </div>
